...
namespace mavjs {
    class Action : public Napi::ObjectWrap<Action> {
        ...
        private:
            ...
            void arm_async(const Napi::CallbackInfo& info);
            void disarm_async(const Napi::CallbackInfo& info);
            void kill_async(const Napi::CallbackInfo& info);
            void takeoff_async(const Napi::CallbackInfo& info);
            void land_async(const Napi::CallbackInfo& info);
            void return_to_launch_async(const Napi::CallbackInfo& info);
            void transition_to_fixedwing_async(const Napi::CallbackInfo& info);
            void transition_to_multicopter_async(const Napi::CallbackInfo& info);
