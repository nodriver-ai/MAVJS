export namespace Telemetry {
    ...
    export interface Telemetry {
      ...
      set_rate_imu_reading_ned(rate_hz: number): void,
      set_rate_gps_info(rate_hz: number): void,
      set_rate_battery(rate_hz: number): void,
      set_rate_rc_status(rate_hz: number): void,
      set_rate_actuator_control_target(rate_hz: number): void,
      set_rate_actuator_output_status(rate_hz: number): void,
